...
from project.bourse import Bourse
from project.local import Local
from project.crypto import Crypto
...
def running():
    ...
    if user_input == 1:
        ...
        if user_input1 == 1:
            ...
            # if local_obj.get_data() == '':
            #     print(bcolors.FAIL + bcolors.BOLD + "We're not able to show the results at the moment, please"
            #                                         " try again later!" + bcolors.ENDC)
            # else:
